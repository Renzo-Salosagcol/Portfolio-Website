...
const About = () => {
  console.log("PERSONAL_INFO:", PERSONAL_INFO); // Debug log
  console.log("EDUCATION_INFO:", EDUCATION_INFO); // Debug log
  console.log("EXPERIENCE_INFO:", EXPERIENCE_INFO); // Debug log
